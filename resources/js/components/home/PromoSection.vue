<template>
  <section id="promo" class="py-12 bg-white scroll-mt-20">
        ...
        <div class="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center p-8 sm:p-12 lg:p-14">
          ...
          <div class="lg:col-span-8 space-y-4 max-w-xl">
            <div class="inline-flex items-center gap-2 px-3 py-1 bg-red-500/20 border border-red-500/30 rounded-full">
              ...
              <span class="text-[11px] font-bold text-[#F87171] uppercase tracking-widest">Promo Spesial Bulan Ini</span>
            </div>
            ...
            <p class="text-xs sm:text-base text-stone-300 leading-relaxed font-normal">
              Dapatkan kemudahan pembelian motor bekas pilihan dengan DP terjangkau, cicilan ringan, dan proses persetujuan cepat di Laksana Motor.
            </p>
            <div class="pt-2">
              <a
                :href="whatsappUrl"
          ...
          <div class="lg:col-span-4 flex justify-center lg:justify-end">
            <div class="w-40 h-48 bg-gradient-to-b from-[#DC2626] to-[#991B1B] border-2 border-white/25 rounded-2xl flex flex-col items-center justify-center text-center p-4 shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-300">
              ...
              <span class="text-[11px] font-bold text-white uppercase tracking-wider mt-1">DP MULAI</span>
              <span class="text-6xl font-black text-white my-0.5 drop-shadow-md">1</span>
              <span class="text-xs font-black text-white uppercase tracking-widest bg-white/20 px-3 py-1 rounded-md">JUTAAN</span>
            </div>
          </div>
        </div>
      </div>
